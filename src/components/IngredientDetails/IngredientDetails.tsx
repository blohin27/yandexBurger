...
export const IngredientDetails: FC<IIngredientDetailsComponent> = ({
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={classNames(styles.name, "text text_type_main-medium")}>
        {item.name}
      </div>
      <div className={styles.structureIngredients}>
        <div
        ...
        >
          <div className={styles.structureItemText}> Протеины,&nbsp; белки</div>
        ...
        >
          ...
          <div className={styles.structureItemValue}>{item.carbohydrates}</div>
        </div>
      </div>
    </div>
  );
