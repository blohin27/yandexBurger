import {
  ...
  wsMessage,
  wsError,
} from "../services/actions/actionsMyOrder"; // замените на путь к вашему редьюсеру
import {
  initialState,
  WebsocketStatus,
} from "../services/reducers/myOrderWsReducer";
import { MyOrderFeedReducer } from "../services/reducers/myOrderWsReducer";
...
describe("MyOrderFeedReducer reducer", () => {
  it("should handle wsOpen", () => {
    ...
    const newState = MyOrderFeedReducer(initialState, action);
  ...
  it("should return initialState if state is undefined", () => {
    const newState = MyOrderFeedReducer(undefined, {});
